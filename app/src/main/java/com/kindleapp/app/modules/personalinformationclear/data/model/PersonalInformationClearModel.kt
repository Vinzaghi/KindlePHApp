package com.kindleapp.app.modules.personalinformationclear.`data`.model

import com.kindleapp.app.R
import com.kindleapp.app.appcomponents.di.MyApp
import kotlin.String

data class PersonalInformationClearModel(
  /**
   ...
   * TODO Replace with dynamic value
   */
  var txtTitle: String? = MyApp.getInstance().resources.getString(R.string.msg_clear_personal)
  ,
  /**
   * TODO Replace with dynamic value
   */
  var txtDescription: String? = MyApp.getInstance().resources.getString(R.string.msg_click_anywhere)
  ,
  /**
   * TODO Replace with dynamic value
   */
