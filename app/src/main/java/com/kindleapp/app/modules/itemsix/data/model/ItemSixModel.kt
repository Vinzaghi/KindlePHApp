package com.kindleapp.app.modules.itemsix.`data`.model

import com.kindleapp.app.R
import com.kindleapp.app.appcomponents.di.MyApp
import kotlin.String

data class ItemSixModel(
  /**
   ...
   * TODO Replace with dynamic value
   */
  var txtPrice: String? = MyApp.getInstance().resources.getString(R.string.lbl_3000_002)
  ,
  /**
   * TODO Replace with dynamic value
   */
