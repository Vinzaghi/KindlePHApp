package com.kindleapp.app.modules.createproductsuccessful.`data`.model

import com.kindleapp.app.R
import com.kindleapp.app.appcomponents.di.MyApp
import kotlin.String

data class CreateProductSuccessfulModel(
  /**
   ...
   * TODO Replace with dynamic value
   */
  var txtTitle: String? = MyApp.getInstance().resources.getString(R.string.msg_create_product)
  ,
  /**
   * TODO Replace with dynamic value
   */
  var txtPersonalInform: String? =
      MyApp.getInstance().resources.getString(R.string.msg_if_you_wish_to)
  ,
  /**
   * TODO Replace with dynamic value
   */
