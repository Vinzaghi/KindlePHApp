package com.kindleapp.app.modules.itemfive.`data`.model

import com.kindleapp.app.R
import com.kindleapp.app.appcomponents.di.MyApp
import kotlin.String

data class ItemFiveModel(
  /**
   ...
   * TODO Replace with dynamic value
   */
  var txtPrice: String? = MyApp.getInstance().resources.getString(R.string.lbl_999_003)
  ,
  /**
   * TODO Replace with dynamic value
   */
